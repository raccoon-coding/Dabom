...
const props = defineProps(['isMaster', 'socket', 'messages'])
...
<!--            <Message v-for="i in 10" />-->
        ...
        <div class="chat-input-container">
            <div class="chat-input-wrapper">
                <input type="text" class="chat-input" id="chatInput" v-model="writeMessage" placeholder="메시지를 입력하세요..." maxlength="200">
